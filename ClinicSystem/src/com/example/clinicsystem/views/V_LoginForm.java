/*
 * Created by JFormDesigner on Thu Nov 28 18:01:15 EET 2019
 */
...
public class V_LoginForm extends JPanel {
    ...
    private void textFieldUsernameFocusGained(FocusEvent e) {
        if(textFieldUsername.getText().equals("ID")) {
            ...
            panelHeaderLayout.setHorizontalGroup(
                panelHeaderLayout.createParallelGroup()
                    .addGroup(panelHeaderLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED, 753, Short.MAX_VALUE)
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup()
                .addGroup(layout.createSequentialGroup()
                    ...
                    .addComponent(panelBody, GroupLayout.DEFAULT_SIZE, 582, Short.MAX_VALUE)
                    .addContainerGap())
        );
