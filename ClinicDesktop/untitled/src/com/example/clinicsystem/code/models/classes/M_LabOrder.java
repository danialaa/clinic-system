...
import com.example.clinicsystem.code.models.interfaces.IAddDetail;

public class M_LabOrder implements IAddDetail {
    ...
    public M_LabOrder(int orderID, int dentistID, int patientID, int supervisorID, int extraFees, boolean isRemovable, String date, String status) {
