/*
 * Created by JFormDesigner on Wed Nov 27 21:30:47 EET 2019
 */

package com.example.clinicsystem.code.views;

import com.example.clinicsystem.code.controllers.C_Employee;
...
public class V_AddEmployeeForm extends JPanel {
    ...
    private void initComponents() {
        ...
        datePicker.setForeground(new Color(32, 32, 82));
        datePicker.setBackground(new Color(255, 255, 255));
        datePicker.setFont(new Font("Helvetica-Normal", Font.PLAIN, 12));
        panelBirth.add(datePicker, BorderLayout.CENTER);
