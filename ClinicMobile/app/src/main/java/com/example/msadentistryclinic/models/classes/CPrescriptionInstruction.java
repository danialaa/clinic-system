...
public class CPrescriptionInstruction {
    private int drugID, quantity, duration, dose;
    private String durationType, instructionDetails;

    public CPrescriptionInstruction(int drugID, int duration, int dose, String durationType, String instructionDetails, int quantity) {
        this.drugID = drugID;
    ...
    public CPrescriptionInstruction() {
    }
