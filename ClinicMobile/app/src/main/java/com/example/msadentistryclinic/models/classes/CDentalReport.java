...
public class CDentalReport implements IAddDetail {
    ...
    public CDentalReport(int reportID, int patientID, int dentistID, int cavityCount, int fillingDecayCount, int appointmentID, String date, String gumStatus, String xray, String consentProof, boolean isPatientConsent) {
